...
import anthropic
import openai
from src.config.settings import LLM_PROVIDER_MAP 
...
class LLMService:
    ...
    def __init__(
        ...
        # 确定提供商
        self.provider = LLM_PROVIDER_MAP.get(model_name, "unknown")
        # 初始化客户端
